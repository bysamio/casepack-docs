---
title: Pricing Plans
description: CasePack subscription tiers, feature comparison, and checkout flow.
---

CasePack offers four subscription tiers designed for different team sizes and deployment needs. Plans are available with monthly or yearly billing (yearly saves ~17%).
...
- **Yearly** — Save ~17%, billed annually
- Self-Host Standard is **annual only** (no monthly option)
